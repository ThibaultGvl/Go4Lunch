...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                if (newText.length()  >= 3) {
                    //mNearbyRestaurantViewModel.getRestaurantBySearch(newText, "AIzaSyA8fqLfJRcp8jVraX7TatTFkykuTHJUzt4").observe(this, this::setPrediction);
                }
                return false;
            }
        });
    ...
    public void setPrediction(RestaurantAutoComplete restaurantAutoComplete) {
        mPrediction = restaurantAutoComplete.getPredictions();
    }*/
